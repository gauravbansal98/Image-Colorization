...
class ColorizeImageTorch(ColorizeImageBase):
    ...
    def net_forward(self, input_ab, input_mask):
        ...
        # embed()
        # print(self.net.forward(self.img_l_mc, self.input_ab_mc, self.input_mask_mult, self.mask_cent))
        # print(type(self.net.forward(self.img_l_mc, self.input_ab_mc, self.input_mask_mult, self.mask_cent)))
        # print(self.net.forward(self.img_l_mc, self.input_ab_mc, self.input_mask_mult, self.mask_cent),shape)
